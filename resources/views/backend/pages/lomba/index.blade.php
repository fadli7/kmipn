    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-block">
                <a href="{{ url('/backend/lomba/create') }}" class="btn btn-success pull-right">Create New</a>
                        ...
                        <tr>
                            ...
                            <td width="153">
                                <form action="{{ url('/backend/lomba/'.$item->id) }}" method="post">
                                    ...
                                    <a href="{{ url('/backend/lomba/'.$item->id.'/edit') }}" class="btn btn-info"><i class="fa fa-pencil"></i> Edit</a>
